          ...
          <div className="max-w-6xl mx-auto">
              ...
              <div className="mt-8 space-y-6">
                  ...
                  <section>
                      ...
                      <p className="text-white">
                          All content on this website (including text, images, graphics, and logos) is owned by or licensed to Twenty Eight Barbers.
                  ...
                  <section>
                      ...
                      <div className="text-white">
                          <p><strong>Twenty Eight Barbers</strong></p>
                          <p>Email: <a href="mailto:jaybo28@me.com" className="text-yellow-400 hover:underline">jaybo28@me.com</a></p>
                          <p>Phone: 0115 958 6628</p>
                          <p>Address: 32 Pelham Street Nottingham NG1 2EG </p>
                      </div>
                  </section>
              </div>
          </div>
